...
class QuarterField(models.CharField):
    ...
    QUARTERS = Choices((Q1, "Q1"), (Q2, "Q2"), (Q3, "Q3"), (Q4, "Q4"))
...
def coded_create_reverse_many_to_one_manager(superclass, rel):
    class RelatedManager(superclass):
        ...
        def get_prefetch_queryset(self, *args, **kwargs):  # dj4
        ...
        def get_prefetch_querysets(self, *args, **kwargs):  # dj5
            rel_qs, rel_obj_attr, instance_attr, single, cache_name, is_descriptor = super().get_prefetch_querysets(
                *args, **kwargs
            )
...
class CodedReverseManyToOneDescriptor(ReverseGenericManyToOneDescriptor):
    ...
    def related_manager_cls(self):
        return coded_create_reverse_many_to_one_manager(super().related_manager_cls, self.rel)
